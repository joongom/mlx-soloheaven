#!/bin/bash
# Start SoloHeaven with Gemma 4 26B-A4B 8-bit target; MTP drafter line commented out by default.
# Drafter slug: mlx-community/gemma-4-26B-A4B-it-assistant-bf16 (expected at $HOME/.lmstudio/models/<slug>).
...
# TODO: verify 26B-A4B target and drafter paths exist on disk before running; update slugs if canonical names differ.
MODEL_PATH="$HOME/.lmstudio/models/lmstudio-community/gemma-4-26B-A4B-it-MLX-8bit"
DRAFT_PATH="${DRAFT_PATH:-$HOME/.lmstudio/models/mlx-community/gemma-4-26B-A4B-it-assistant-bf16}"

...
# Session-cache shared types/helpers live in the neutral leaf module
# session_cache_types (dependency arrow: mlx_engine -> session_cache_mixin
# -> session_cache_types). Re-imported here so existing bare-name references
# in this module and public test imports (from ...mlx_engine import
# SessionState / BaseCacheEntry / TurnCloseResult / _strip_content_channel_tool_xml)
# keep resolving unchanged.
from mlx_soloheaven.engine.session_cache_types import (  # noqa: F401
    BaseCacheEntry,
    SessionState,
    TurnCloseResult,
